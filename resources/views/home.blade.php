...
<div class="w-full py-32 relative" id="how">
  ...
  <div class="w-97 md:w-11/12 lg:w-9/12 mx-auto">
    ...
    <div class="w-full flex flex-wrap xl:flex-nowrap justify-center xl:justify-between items-center my-20">
    ...
    <div class="text-center">
      <a href="#" class="px-8 py-2 text-xl font-medium bg-white text-secondary border border-pink rounded-xl shadow-md  tracking-wider hover:bg-pink  hover:text-white  hover:shadow-xl transform hover:scale-105 inline-block transition duration-300 ease-out">Take the assement!</a>
...
<div class="w-full bg-third py-20" id="why">
  <div class="w-97 md:w-11/12 lg:w-8/12 mx-auto flex flex-col-reverse lg:flex-row justify-between">
...
<div class="w-full bg-white py-32" id="assesment">
